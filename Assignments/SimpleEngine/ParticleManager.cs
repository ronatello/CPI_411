...
namespace CPI411.SimpleEngine
{
    public class ParticleManager
    {
        ...
        public ParticleManager(GraphicsDevice g, int max)
        {
            ...
            for (int i = 0; i < max; i++)
            {
                vtx[i * 4 + 0] = new VertexInfo(new Vector4(-1, -1, 0, 1), new
                Vector2(0, 1));
                vtx[i * 4 + 1] = new VertexInfo(new Vector4(-1, 1, 0, 1), new
                Vector2(0, 0));
                vtx[i * 4 + 2] = new VertexInfo(new Vector4(1, -1, 0, 1), new
                Vector2(1, 1));
                vtx[i * 4 + 3] = new VertexInfo(new Vector4(1, 1, 0, 1), new
                Vector2(1, 0));
            }
            ...
            {
                idx[i * 6 + 0] = (ushort)(i * 4 + 0); idx[i * 6 + 1] = (ushort)(i *
                4 + 1); idx[i * 6 + 2] = (ushort)(i * 4 + 2);
                idx[i * 6 + 3] = (ushort)(i * 4 + 1); idx[i * 6 + 4] = (ushort)(i *
                4 + 3); idx[i * 6 + 5] = (ushort)(i * 4 + 2);
            }
